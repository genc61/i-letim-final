...
$action = New-ScheduledTaskAction -Execute 'Powershell.exe'  -Argument 'C:\Users\BURAK\Desktop\Scripts-IsletimSistemleriFinalOdevi\algoritma1.ps1'
...
$action = New-ScheduledTaskAction -Execute 'Powershell.exe'  -Argument 'C:\Users\BURAK\Desktop\Scripts-IsletimSistemleriFinalOdevi\algoritma2.ps1'
